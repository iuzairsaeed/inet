                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="col-md-8 font-familyAtlasGroteskWeb-Medium font-size13px customDropDownInnerPg pt-md-5 pt-0 pb-4 ">
                                <div class="row">
                                    ...
                                    <div class="col mb-3">
                                        <select id='content_sort_new' name='sort' class="selectpicker border font-familyFreightTextProLight-Regular text-darkBlue">
                                            ...
                                            @if ($content->status == 1)
                                             ...
                                             @endif
                                                        ...
                                                        <div style="border-bottom: 2px solid #b1b1b1 !important; padding-bottom: 8px !important;" class="card-header bg-transparent border-0 pb-0 pt-2 d-flex flex-wrap">
                                                            ...
                                                            <div class="col-sm-6 font-size14px font-familyAtlasGroteskWeb-Regular text-colorblue200 p-0 p-2 text-right"><small><span style="padding-right: 8px;" class="fas fa-eye"></span>{{ $content->views_count }}</small></div>
                                                            </div>
                                                        ...
                                                        <div class="w-100 bg-lightWhite p-2" style="border-radius:0px 30px 30px 0px;max-width: 179px;">
                                                         <h6 class="font-familyAtlasGrotesk-Regular text-colorblue200 font-size12px m-0" style="line-height: 2.3;"><img src="{{ asset('images/bookicon.png') }}" width="25" class="mr-1"> Course ({{$content->count}} items) </h6>
                                                        </div>
            ...
            <div class="form-container modal-content border-radius0px">
                <form id="add_content_form_with_detail" action="{{ route('contentAddWithDetail') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="form-group font-familyAtlasGroteskWeb-Medium text-colorblue100 mb-3 customFileMain">
                                    ...
                                    <p class="font-familyAtlasGroteskWeb-Light p-0 text-colorblue200 font-size13px">Add your thumbnail for your Content.</p>
                                    <div class="custom-file">
                                        <input accept="image/*" type="file" id="content_image" class="custom-file-input col-md-12 p-0 getVal2">
                        ...
                        <div class="reminder-text">By submitting materials, you confirm you are not violating othersÃ¢â‚¬â„¢ copyright rights, the materials may be used by others under the Terms of Service, and you agree to the <a href="{{ route('termsConditions')}}" target="_blank">Terms of Service </a>.</div>
