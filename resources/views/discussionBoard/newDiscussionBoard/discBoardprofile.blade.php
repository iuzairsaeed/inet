@extends('layouts.app') @section('title') INET ED Platform :: View Profile @endsection @section('content')
    <style>
        ...
        <?php $user_content_list = explode(",", $user_content_updated_list);
                ...
                $cTags = json_decode($profile->tags,true);}
                $cCategoryIds = array_filter(explode(',', $profile->category_ids));
 ?>
        ...
        <div class="row">
            <div class="col-md-9 pt-5 pb-5 ">
                ...
                <div class="media mt-5 font-size14px">
                     <div class="thumbnailImg_WH1 thumbnailImg" style="background: url({{ url('/public/uploads/profile_images') . '/'. $profile->profile_pic_url }}) no-repeat; background-size: cover;">
                     </div>
                    <div class="media-body">
                        <h5 class="mt-0 font-familyAtlasGrotesk-Medium text-colorblue100 d-flex"><span class="align-self-center">{{ $profile->full_name }}</span> <span class="badge badge-secondary font-familyFreightTextProMedium-Italic font-size13px pl-3 pr-3 pt-2 ml-2 pb-2">{{ $role['0']->name }}</span></h5>
                        <p class="text-colorblue200 font-familyAtlasGroteskWeb-Regular mb-1">{!! $profile->about_me !!}</p>
                        {{--<p class="text-colorblue200 font-familyAtlasGroteskWeb-Regular">{!! $profile->about_me !!}</p>--}}
                        ...
                        <div class="mb-4">
                          {{--  <a href="#" class="font-familyAtlasGroteskWeb-Regular text-colorblue200 font-size13px">{!! Auth::user()->email !!}</a>--}}
                            <div class="">
                                ...
                                @else
                                <a href="{{ $profile->twitter_url }}" class="text-colorblue200" target="_blank"><i class="fab fa-twitter"></i></a>
                                @endif

                                @if ( $profile->youtube_url == "")
                                <a href="#"class="text-colorblue200 ml-3 mr-3"><i class="fab fa-youtube"></i></a>
                                @else
                                <a href="{{ $profile->youtube_url }}"class="text-colorblue200 ml-3 mr-3"  target="_blank"><i class="fab fa-youtube"></i></a>
                                @endif
                                ...
                                @else
                                <a href="{{ $profile->web_url }}" class="text-colorblue200"  target="_blank"><i class="fas fa-globe"></i></a>
                                @endif
                            </div>
                        </div>
                        ...
                        <ul class="relatedTag font-familyAtlasGroteskWeb-Medium">
                                 <?php
                                    $tags = json_decode($tagsonly['0']->tags, true);
                                    if($tags!=Null){
                                    if (count($tags)) {
                                        foreach ($tags as $tag) {
           ...
           @if(Auth::check())
            ...
            <div class="col-md-12 pb-5">
                <div class="col-md-12 border-top border-bottom pt-4 pb-4 font-familyAtlasGrotesk-Medium font-size14px">
                    ...
                    <div class="row">
                      @foreach ($tagsncat2 as $tagsncat2)
                       @if($role['0']->id == 1 ||  $role['0']->id == 3)
                        <div class="col-md-3">
                            <p class="text-colorblue200 mb-0 font-size12px">Affiliation</p>
                            <p class="font-familyFreightTextProLight-Regular mb-0">{!! $tagsncat2->affiliation  !!}</p>
                        </div>
                       @endif
                        <div class="col-md-3">
                            <p class="text-colorblue200 mb-0 font-size12px">Country</p>
                            <p class="font-familyFreightTextProLight-Regular">{!! $tagsncat2->country !!}</p>
                        </div>
                        <div class="col-md-3">
                            <p class="text-colorblue200 mb-0 font-size12px">Gender</p>
                            <p class="font-familyFreightTextProLight-Regular mb-0">{!! $tagsncat2->gender !!}</p>
                        </div>
                        <div class="col-md-3">
                            <p class="text-colorblue200 mb-0 font-size12px">Email</p>
                            <p class="font-familyFreightTextProLight-Regular mb-0">{!! $tagsncat2->email !!}</p>
                        </div>
                      @endforeach
                    </div>
                </div>
          ...
          @endif
            ...
            @if(count($userdetailsnew))
            @foreach ($userdetailsnew as $item)
                     ...
                     <div class="tab-pane fade" id="pg-contributionsNew" role="tabpanel" aria-labelledby="Contributions">
                        <div id="content_thumbnail_view" class="col-md-12 pt-4 pb-4">
                         <div class="row" id="content_result">
                          @if(count($my_contributions))
                          @foreach ($my_contributions as $contribution)
                                                <div class="col-lg-4 col-md-6 mb-3 d-flex bookmarkCheck">
                                                    <div class="card col-12 p-0 border-radius0all">
                                                        <a href="/inetEDPlatform/content/view/{!!$contribution->id !!}">
            ...
            <div class="modal-body p-4">
                <form id="profile_update_form" action="{{ route('updateProfile') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group font-familyAtlasGroteskWeb-Medium text-colorblue100 mb-3">
                        ...
                        <input value="{{ $profile->full_name }}" id="profile_image" type="text" class="form-control font-familyFreightTextProLight-Regular text-darkBlue" name="profile_fullName" placeholder="Name">
                    </div>
                    ...
                    <div class="form-group font-familyAtlasGroteskWeb-Medium text-colorblue100 mb-3">
                        ...
                        <input value="{{ $profile->twitter_url }}" id="twitter_url" type="text" class="form-control font-familyFreightTextProLight-Regular text-darkBlue" name="twitter_url" placeholder="twitter url">
                    </div>
                    ...
                    <div class="form-group font-familyAtlasGroteskWeb-Medium text-colorblue100 mb-3">
                        ...
                        <input value="{{ $profile->youtube_url }}" id="youtube_url" type="text" class="form-control font-familyFreightTextProLight-Regular text-darkBlue" name="youtube_url" placeholder="youtube url">
                    </div>
                    ...
                    <div class="form-group font-familyAtlasGroteskWeb-Medium text-colorblue100 mb-3">
                        ...
                        <input value="{{ $profile->web_url }}" id="web_url" type="text" class="form-control font-familyFreightTextProLight-Regular text-darkBlue" name="web_url" placeholder="web url">
                    </div>
                    ...
                    <div class="form-group font-familyAtlasGroteskWeb-Medium text-colorblue100">
                       ...
                       <textarea class="form-control font-familyFreightTextProLight-Regular text-darkBlue"  id="profile_discription_c" placeholder="Content Description" rows="6" cols="260" onkeyup="charcountupdate(this.value)"  maxlength="160">{!! $profile->about_me !!}</textarea>
