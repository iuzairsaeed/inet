...
@section('content')
    ...
    <section class="pt-5 pb-5 bg-white">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h6 class="font-familyAtlasGroteskWeb-Regular mb-3"><span class="text-colorMahroon700">Discussion Board</span> <i class="fas fa-angle-right ml-3 mr-3 text-colorMahroon100"></i> <span class="text-colorMahroon600">View Moderators</span></h6>

                    <div class="col-md-12 p-0 mb-4">
                        <div class="row justify-content-between">
                            <div class="col-md-6">
                                <h3 class="text-black font-familyAtlasGroteskWeb-Bold mb-0">View Moderators</h3>
                            </div>
                            {{-- <div class="col-md-3">
                ...
                <div class="col-lg-3 col-md-4 mb-3 d-flex">
                    <div class="card col-md-12 p-0 border-radius0px dashboardDataTable ModratorMenuMain">
                        ...
                        <div class="col text-center pb-4 pt-4">
                            ...
                            <h5 class="font-familyAtlasGrotesk-Medium text-colorblue100 mt-2 d-flex mb-2 justify-content-center"><img src="{{ asset('images/icons/Icon-M.png') }}" alt="" class="align-self-center"> <span class="ml-2">{!! $item->full_name !!}</span></h5>
