                    ...
                    <div class="col-md-12 bg-white">
                        <div class="row">
                            <div class="col-md-9 pt-5 pb-5">
                                ...
                                <div class="row">
                                    <div class="col-md-6 font-size11px">
                            ...
                            <div class="col-md-3 text-right align-self-center">
                                <div class="row">
                                    @if(Auth::check())
                                    <div class="col-md-12  align-self-center bookmarkCheck pr-4">
                                        <div class="custom-control custom-checkbox mr-sm-2 m-auto">
                                            ...
                                            <label class="custom-control-label text-ferozy" for="bookmark-{{ $content->id }}"><span class="ml-4">Bookmark</span></label>
                                                ...
                                                <div class="col-12 border mb-4 p-0 bg-white">
                                                    <div class="mb-0 d-flex no-gutters pt-2 pb-2 pl-3 pr-3">
                                                        ...
                                                        <div class="col-md-6 text-right align-self-center">
                                                            ...
                                                            <a class="font-familyAtlasGroteskWeb-Bold font-size10px text-colorMahroon700 ml-2 course_delete-mod" href="#" @auth data-contentId="{{$step->mainID}}" data-toggle="modal" @endauth>DELETE</a>
                                                            <ul class="navbar-nav align-self-center font-familyFreightTextProLight-Regular">
                                                                <li class="nav-item dropdown">
                                                                    {{--<a class="nav-link dropdown-toggle p-0 text-lightGaray" href="#" id="listViewMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-ellipsis-h font-size2em"></i></a>--}}
                                                                    <div class="dropdown-menu margin-top2em widthMin15rem border-radius0px right0 aPading transformMenu" aria-labelledby="listViewMenu">
                                                                        <div class="col pl-0 pr-0">
                                                                            ...
                                                                            <a class="dropdown-item font-size14px course_delete-mod" href="#" @auth data-contentId="{{$step->mainID}}" data-toggle="modal" @endauth><i class="far fa-trash-alt mr-2"></i> <span>Delete</span></a>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                            ...
                                                            <ul class="navbar-nav align-self-center font-familyFreightTextProLight-Regular">
                                                                <li class="nav-item dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu margin-top2em widthMin15rem border-radius0px right0 aPading transformMenu" aria-labelledby="listViewMenu">
                                                                        <div class="col pl-0 pr-0">
                                                                            <a class="dropdown-item font-size14px edit-mod" href="#"  @auth data-contentId="{{$step->id}}"  data-toggle="modal" data-target="#moadalAddNewCont" @endauth><i class="far fa-edit mr-2"></i> <span>Edit</span></a>
                                                                            <a class="dropdown-item font-size14px course_delete-mod" href="#" @auth data-contentId="{{$step->mainID}}" @endauth><i class="far fa-trash-alt mr-2"></i> <span>Delete</span></a>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <div class="form-group font-familyAtlasGroteskWeb-Medium text-colorblue100 mb-3">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <p class="font-familyAtlasGroteskWeb-Light p-0 text-colorblue200 font-size13px">The course description is what your student will see.</p>
                                        <p class="text-colorblue200 font-size12px mb-0"><span id="count_up">0</span><span></span></p>
                                    </div>
                            ...
                            <div class="col-md-5">
                                <div class="form-group font-familyAtlasGroteskWeb-Medium text-colorblue100 mb-3 customFileMain">
                                    ...
                                    <p class="font-familyAtlasGroteskWeb-Light p-0 text-colorblue200 font-size13px">Add your thumbnail for your Course.</p>
                            ...
                            <div class="form-group font-familyAtlasGroteskWeb-Medium text-colorblue100 mb-3 customFileMain customFileMain1">
                               ...
                               <div class="col-md-12 borderDotted text-center font-size12px pt-5 pb-5">
                                ...
                                <div class="form-group font-familyAtlasGroteskWeb-Medium text-colorblue100 mb-3 customDropDownInnerPg">
                                    ...
                                    <p class="font-familyAtlasGroteskWeb-Light p-0 text-colorblue200 font-size13px">Choose any seven fields to which your course is most closely related.</p>
                                ...
                                <div class="form-group font-familyAtlasGroteskWeb-Medium text-colorblue100 mb-3 customDropDownInnerPg">
                                    ...
                                    <select id="Restriction" name="privacy_content_01" class="selectpicker border font-familyFreightTextProLight-Regular text-darkBlue">
                                        ...
                                        <option value="0" {{$content->content_privacy == 0 ? 'selected':''}}>Generally Accessible (Default)</option>
                                ...
                                <div class="form-group font-familyAtlasGroteskWeb-Medium text-colorblue100 mb-3 customDropDownInnerPg">
                                    ...
                                    <small id="content_tags_err" style="color: red;color: red;margin: 0.5em 0em 0em 1.2em !important;" class="textError position-absolute"></small>
...
@section('script')
  ...
  $("#institution_or_source_err").html("");
  ...
  if (
    ...
    if (content_title == "") {
      $("#content_title_err").html("Course title required!");
    }

    if (content_discription == "") {
      $("#content_discription_err").html("Course description required!");
    }

    if (affiliation == "") {
      $("#institution_or_source_err").html("Course affiliation required!");
    }
