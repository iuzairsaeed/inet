...
<!-- /////////////////////////////////////////////SAMRA WORK END////////////////////////////////////////////////////////////////////////////////////////////////// -->
                                ...
                                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col border-right mb-3">
                                                ...
                                                foreach ($c as $key => $item) {
                                                    echo "<a href='/inetEDPlatform/courses/$key'><p class='font-familyAtlasGroteskWeb-Medium text-colorNew mb-0'>".$item."</p></a>";
                                                }
                                                ?>
                                            </div>
                                            <div class="col mb-3">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <button type="button" class="btn btn-customBtn4 font-familyAtlasGroteskWeb-Regular font-size12px mb-3"><i class="fas fa-book"></i> Course ({{$courseCount}} items)</button>
                                        @endif
                                    </div>
                            ...
                            <div class="col-md-4 align-self-center">
                                <div class="row">
                                    ...
                                    <div class="col-md-7 border-left text-right">
                                        ...
                                        @auth
                                        @if(Auth::user()->role_id == 3 && $content->status == 1)
                                        
                                          <div class="dropdown" class="form-group font-familyAtlasGroteskWeb-Medium text-colorblue100 mb-3">
                                            <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown"> Add To Course </button>
                                           <div class="dropdown-menu">
                                               @if ($course_data)
                                                    @foreach ($course_data as $course_datas)
                                                        <a class="dropdown-item constTitle" href="#"  data-course_id="{{$course_datas->id}}">{{$course_datas->title}}</a>
                                                    @endforeach
                                                @endif
                                         ...
                                         @endif
                                       @if(Auth::user()->role_id == 1 && $content->status == 1)
                    ...
                    <p class="text-colorblue100 font-size12px mb-0">
                        ...
                        <?php
                            ...
                            $c = array_combine($a, $b);
                                ...
                                foreach ($c as $key => $item) {
                                    echo "<a href='/inetEDPlatform/courses/$key'><span class='mr-2'>".$item."</span></a>";
                                }
                        ?>
                                        ...
                                        @if($step->section == ($i + 1))
                                                                ...
                                                                <li class="nav-item dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu margin-top2em widthMin15rem border-radius0px right0 aPading transformMenu" aria-labelledby="listViewMenu">
                                                                       ...
                                                                       <!-- <a class="dropdown-item font-size14px edit-mod" href="#"  @auth data-contentId="{{$step->id}}"  data-toggle="modal" data-target="#moadalAddNewCont" @endauth><i class="far fa-edit mr-2"></i> <span>Edit</span></a> -->
                                                                            <a class="dropdown-item font-size14px delete-mod" href="#" @auth data-contentId="{{$step->id}}" data-toggle="modal" @endauth><i class="far fa-trash-alt mr-2"></i> <span>Delete</span></a>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                       ...
                                                       <!-- <a href="#" id="listViewMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="font-familyAtlasGroteskWeb-Bold font-size10px text-colorMahroon700 ml-2">Edit</a> -->
                                                            <ul class="navbar-nav align-self-center font-familyFreightTextProLight-Regular">
                                                                <li class="nav-item dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu margin-top2em widthMin15rem border-radius0px right0 aPading transformMenu" aria-labelledby="listViewMenu">
                                                                        <div class="col pl-0 pr-0">
                                                                       <!-- <a class="dropdown-item font-size14px edit-mod" href="#"  @auth data-contentId="{{$step->id}}"  data-toggle="modal" data-target="#moadalAddNewCont" @endauth><i class="far fa-edit mr-2"></i> <span>Edit</span></a> -->                                                                            <a class="dropdown-item font-size14px delete-mod" href="#" @auth data-contentId="{{$step->id}}" data-toggle="modal" @endauth><i class="far fa-trash-alt mr-2"></i> <span>Delete</span></a>                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                            @endif
                                            ...
                                            @elseif($step->type == "Image")
                                                <div class="col-12 border mb-4 p-0 bg-white">
                                                    <div class="mb-0 d-flex no-gutters pt-2 pb-2 pl-3 pr-3">
                                                        <div class="col-md-6 d-flex">
                                                            <img src="{{ asset('images/icons/imagecont.png') }}"  alt="" height="30">
                                                            <div class="align-self-center ml-3">
                                                                <p class="mb-0">{{ $step->title }}</p>
                                                                <p class="mb-0 font-size10px opacity0point5">{{ strtoupper($step->type) }}</p>
                                                            </div>
                                            ...
                                            @elseif($step->type == "Audio")
                                                <div class="col-12 border mb-4 p-0 bg-white">
                                                    <div class="mb-0 d-flex no-gutters pt-2 pb-2 pl-3 pr-3">
                                                        <div class="col-md-6 d-flex">
                                                            <img src="{{ asset('images/icons/audioimgCont.png') }}"  alt="" height="30">
                                                            <div class="align-self-center ml-3">
                                                                <p class="mb-0">{{ $step->title }}</p>
                                                                <p class="mb-0 font-size10px opacity0point5">{{ strtoupper($step->type) }}</p>
                                                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <div class="form-group font-familyAtlasGroteskWeb-Medium text-colorblue100 mb-3">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <p class="text-colorblue200 font-size12px mb-0"><span id="count_up"></span><span> </span></p>
                                    </div>
                                    <textarea class="form-control" name="content_discription2" id="content_discription_up">{!! $content->description !!}</textarea>
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="col-md-12 borderDotted text-center font-size12px pt-5 pb-5">
                                    <div class="custom-file">
                                        <input id="content_image_thumb" name="content_image_thumb" accept="image/*" type="file" class="custom-file-input col-md-12 p-0 getVal2">
                                        <img id="blah" src="{{ asset('images/upload12.jpg') }}" alt="" width="100%" height="160" style="margin-top: -70px;">
                                         <label style="font-size: 40px; height: 32px;" class="custom-file-label col-md-12 d-flex align-items-center justify-content-between" for="content_image_thumb"></label>
                                         <script>
                                          content_image_thumb.onchange = evt => {
                                          const [file] = content_image_thumb.files
                                          if (file) {
                                ...
                                <div class="form-group font-familyAtlasGroteskWeb-Medium text-colorblue100 mb-3 customDropDownInnerPg">
                                    ...
                                    <small id="content_categories2_err_up" style="color: red"></small></div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div id="description_div_up" class="form-group font-familyAtlasGroteskWeb-Medium text-colorblue100 mb-3">
                                    ...
                                    <textarea class="form-control" name="description" id="description_up" rows="6" cols="260">{!! isset($content_details[0]->description) ? $content_details[0]->description:'' !!}</textarea>
    ...
    <div class="modal fade p-0" id="moadalEditCoursem" tabindex="-1" role="dialog" aria-labelledby="moadalEditCoursem" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered max-width790px p-md-0 p-3" role="document">
            <div class="modal-content border-radius0px">
                <form id="edit_course_content_form" action="{{ route('mainContentUpdate') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="content_id" value="{{$content->id}}">
                    <div class="modal-header p-4">
                    ...
                    <div class="modal-body p-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group font-familyAtlasGroteskWeb-Medium text-colorblue100 mb-3 customDropDownInnerPg">
                                    ...
                                    <select id="Restriction" name="privacy_content_01" class="selectpicker border font-familyFreightTextProLight-Regular text-darkBlue">
                                        ...
                                        <option value="0" {{$content->content_privacy == 0 ? 'selected':''}}>Public</option>
                                        <option value="1" {{$content->content_privacy == 1 ? 'selected':''}}>Private</option>
                        ...
                        <div class="reminder-text">By submitting materials, you confirm you are not violating othersâ€™ copyright rights, the materials may be used by others under the Terms of Service, and you agree to the <a href="{{ route('termsConditions')}}" target="_blank">Terms of Service.</a></div>
                    </div>
            ...
            <div class="modal-content border-radius0px">
                <div class="modal-body p-5">
                    <div class="row align-items-center">
                        <div class="col">
                            <h6 class="font-familyAtlasGroteskWeb-Medium text-colorblue100">Would you like to submit your course as a public course?</h6>
                    ...
                    <div class="form-container">
                        ...
                        <form id="content_step_form1" action="{{ route('contentUploadEdit') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div id="description_div" class="form-group font-familyAtlasGroteskWeb-Medium text-colorblue100 mb-3">
                                ...
                                <textarea class="form-control" name="description" id="descriptionD" rows="6" cols="260">{!! isset($content_details[0]->description) ? $content_details[0]->description:'' !!}</textarea>
                            </div>
...
@section('script')
    ...
    $(document).ready(function() {
        $("#description_up").tinyMCE.triggerSave();
    }); 
    ...
    $('.edit-mod').click(function() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#descriptionD").text(content.description);
  ...
  // course edit
    // $('#edit_course_content_form').submit(function(e) {
    //     e.preventDefault();
    //     var formData = new FormData(this);
  ...
  var content_title = $("#content_title_up").val();
  var content_discription = $("#content_discription_up").val();
  var affiliation = $("#affiliation_up").val();
  var author = $("#author_up").val();
  var difficulty_level = $("#difficulty_level_up").val();
  var tags = $("#selectpickerTags_up").select2("val");
  var categories = $("#selectpickerCategories_up").select2("val");



  $("#content_title2_err_up").html("");
  $("#content_discription2_err_up").html("");
  $("#content_affiliation2_err_up").html("");
  $("#content_difficulty_level2_err_up").html("");
  $("#content_avatar2_err").html("");
  $("#content_categories2_err_up").html("");
  $("#content_tags2_err_up").html("");
  ...
  if (
    ...
    if (content_title == "") {
      $("#content_title2_err_up").html("Content title required!");
    }

    if (content_discription == "") {
      $("#content_discription2_err_up").html("Content description required!");
    }

    if (affiliation == "") {
      $("#content_affiliation2_err_up").html("Content affiliation required!");
    }

    if (author == "") {
        $("#author_err_up").html("Author required!");
      }
    ...
    if (!categories) {
      $("#content_categories2_err_up").html("Content categories required!");
    }

    if (!tags) {
      $("#content_tags2_err_up").html("Content tags required!");
    }
    return;
  }
...
$(".constTitle").on("click", function (e) {
...
// if (confirm('Are you sure you want to add this?')) {
   ...
   var content_id  = '{{ collect(request()->segments())->last() }}';
    ...
    $.ajax({
        type: "POST",
        url: '{{ route("AddContentToCourse") }}',
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
        data: {course_id:course_id,content_id:content_id},
        // cache: false,
        // contentType: false,
        // processData: false,
        success: function (data) {
           ...
           if(data.status == 1){alert('Course added successfully');}
           else{alert('Course already added to the playlist.');}

           // alert('This content added successfully to course');
...
$(".constTitle2").on("click", function (e) {
    ...
    $.ajax({
        ...
        success: function () {
            ...
            alert('This content is already exists in your selected course');
