    ...
    <div class="container">
        <div class="row no-gutters justify-content-center">
            ...
            <div class="col-md-6 bg-white box-shadow p-5 font-familyAtlasGroteskWeb-Regular font-size14px height45em">
                ...
                <p class="text-colorblue200 mt-4">An email has been to morty.maxel@email.com with a link to verify your account. If you haven’t received the email after a few minutes, please check your spam folder.</p>
