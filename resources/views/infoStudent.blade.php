...
@section('content')
          ...
          <div class="col-sm-12 col-12 bg-lightWhite200 d-sm-flex pl-4 pt-5 pb-5 pr-4">
                <div class="col-md-4 col-12 text-center">
                   <!-- <img src="{{ asset('images/icons/img2.png')}}" class="img-fluid img-cirlce" style="width: 105px;"> -->
                    ...
                    <div id="img-cusThumbnail-31" name="img-cusThumbnail-31" class="img-cusThumbnail" style="background: url(https://ineted.org/inetadmin/public/{{$st->user_image}}) no-repeat; background-size: cover; background-repeat: no-repeat;"></div>
  ...
  <div class="container">
        ...
        <div class="col-lg-7 pr-0 pl-sm-4 pl-0">
          <div class="col-sm-12 col-12 bg-lightWhite200 d-sm-flex pl-4 pt-5 pb-5 pr-4">
                <div class="col-md-4 col-12 text-center">
                     <div id="img-cusThumbnail-31" name="img-cusThumbnail-31" class="img-cusThumbnail" style="background: url(https://ineted.org/inetadmin/public/{{$st->teacher_image}}) no-repeat; background-size: cover; background-repeat: no-repeat;"></div>
...
<section class="p-0 pb-5">
  <div class="container">
        <div class="row">
          ...
          <div class="col-sm-12 col-12 bg-lightWhite200 d-sm-flex pl-4 pt-5 pb-5 pr-4">
                <div class="col-md-4 col-12 text-center">
                     <div id="img-cusThumbnail-31" name="img-cusThumbnail-31" class="img-cusThumbnail" style="background: url(https://ineted.org/inetadmin/public/{{$st->user_teacher_2_image}}) no-repeat; background-size: cover; background-repeat: no-repeat;"></div>
