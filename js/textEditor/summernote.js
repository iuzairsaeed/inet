...
var LinkDialog_LinkDialog = /*#__PURE__*/function () {
  ...
  LinkDialog_createClass(LinkDialog, [{
    ...
    value: function initialize() {
      ...
      var body = ['<div class="form-group note-form-group">', "<label for=\"note-dialog-link-txt-".concat(this.options.id, "\" class=\"note-form-label font-size13px\">").concat(this.lang.link.textToDisplay, "</label>"), "<input id=\"note-dialog-link-txt-".concat(this.options.id, "\" class=\"note-link-text form-control font-familyFreightTextProLight-Regular text-darkBlue note-form-control note-input\" type=\"text\"/>"), '</div>', '<div class="form-group note-form-group">', "<label for=\"note-dialog-link-url-".concat(this.options.id, "\" class=\"note-form-label font-size13px\">").concat(this.lang.link.url, "</label>"), "<input id=\"note-dialog-link-url-".concat(this.options.id, "\" class=\"note-link-url form-control font-familyFreightTextProLight-Regular text-darkBlue note-form-control note-input\" type=\"text\" value=\"http://\"/>"), '</div>', !this.options.disableLinkTarget ? external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<div/>').append(this.ui.checkbox({
      ...
      var buttonClass = 'btn btn-customBtn2 text-white font-familyAtlasGroteskWeb-Bold font-size12px p-2 border-radius0px note-btn note-btn-primary note-link-btn';
...
var ImageDialog_ImageDialog = /*#__PURE__*/function () {
  ...
  ImageDialog_createClass(ImageDialog, [{
    ...
    value: function initialize() {
      ...
      var $container = this.options.dialogsInBody ? this.$body : this.options.container;
      var body = ['<div class="form-group note-form-group note-group-select-from-files font-size13px">', '<label for="note-dialog-image-file-' + this.options.id + '" class="note-form-label">' + this.lang.image.selectFromFiles + '</label>', '<input id="note-dialog-image-file-' + this.options.id + '" class="note-image-input form-control-file note-form-control note-input" ', ' type="file" name="files" accept="image/*" multiple="multiple"/>', imageLimitation, '</div>', '<div class="form-group note-group-image-url font-size13px">', '<label for="note-dialog-image-url-' + this.options.id + '" class="note-form-label">' + this.lang.image.url + '</label>', '<input id="note-dialog-image-url-' + this.options.id + '" class="note-image-url form-control font-familyFreightTextProLight-Regular text-darkBlue note-form-control note-input" type="text"/>', '</div>'].join('');
      var buttonClass = 'btn btn-customBtn2 text-white font-familyAtlasGroteskWeb-Bold font-size12px p-2 border-radius0px note-btn note-btn-primary note-image-btn';
...
var VideoDialog_VideoDialog = /*#__PURE__*/function () {
  ...
  VideoDialog_createClass(VideoDialog, [{
    ...
    value: function initialize() {
      var $container = this.options.dialogsInBody ? this.$body : this.options.container;
      var body = ['<div class="form-group note-form-group row-fluid">', "<label for=\"note-dialog-video-url-".concat(this.options.id, "\" class=\"note-form-label font-size13px\">").concat(this.lang.video.url, " <small class=\"text-muted\">").concat(this.lang.video.providers, "</small></label>"), "<input id=\"note-dialog-video-url-".concat(this.options.id, "\" class=\"note-video-url form-control font-familyFreightTextProLight-Regular text-darkBlue note-form-control note-input\" type=\"text\"/>"), '</div>'].join('');
      var buttonClass = 'btn btn-customBtn2 text-white font-familyAtlasGroteskWeb-Bold font-size12px p-2 border-radius0px note-btn note-btn-primary note-video-btn';
...
var dialog = renderer["a" /* default */].create('<div class="modal note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', function ($node, options) {
  ...
  $node.html(['<div class="modal-dialog">', '<div class="modal-content border-radius0px">', options.title ? '<div class="modal-header">' + '<h6 class="modal-title font-familyAtlasGroteskWeb-Bold text-colorblue100">' + options.title + '</h6>' + '<button type="button" class="close text-colorMahroon700 outlineNone" data-dismiss="modal" aria-label="Close" aria-hidden="true">&times;</button>' + '</div>' : '', '<div class="modal-body">' + options.body + '</div>', options.footer ? '<div class="modal-footer">' + options.footer + '</div>' : '', '</div>', '</div>'].join(''));
});
